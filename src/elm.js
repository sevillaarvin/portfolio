...
var $author$project$Main$projectView = function (project) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('resume__project-item')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('resume__project-description')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('resume__project-keywords')
					]),
				A2(
					$elm$core$List$map,
					function (keyword) {
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('resume__project-url')
					]),
				_List_fromArray(
					[
						A2(
